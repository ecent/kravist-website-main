...
const YouthLearnMore = () => {
  ...
  return (
    <>
      <SEO
        title="Kids & Teens Krav Maga Singapore | Youth Self-Defence Ages 6-17 | Kravist"
        description="Structured Krav Maga classes for kids (6-10), juniors (10-14), and teens (14-17) in Singapore. Build confidence, discipline, and real self-defence skills. Term programs with certified instructors. Book a $10 trial."
        url="https://www.kravist.sg/programs/youth/learn-more"
        keywords="kids krav maga singapore, youth self defence singapore, martial arts for kids singapore, teens self defence, children confidence building, anti bullying classes singapore, kids enrichment tai seng"
      />
            ...
            <div className="grid lg:grid-cols-2 gap-12 max-w-7xl mx-auto items-center">
              <div className="space-y-8">
                {whyChooseUs.map((item, index) => {
                  ...
                  return (
                    <Card key={index} className="bg-gradient-to-br from-gray-800 to-gray-900 border-rule text-white">
                      <CardContent className="p-8">
                        <div className="flex items-start gap-6">
                          <div className="p-3 bg-k-orange-hover rounded-lg flex-shrink-0">
              ...
              <div className="order-1 lg:order-2">
                <div className="grid gap-4">
                  {classStructure.map((item, index) => (
                    <div key={index} className="flex items-center gap-6 p-5 rounded-lg bg-gray-900 border border-rule hover:bg-gray-800 transition-colors">
                      <div className="flex-shrink-0 w-14 h-14 bg-k-orange-hover text-white rounded-full flex items-center justify-center font-bold text-lg">
                        {item.step}
                      </div>
              ...
              <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-rule text-white">
                <CardContent className="p-8">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h3 className="font-bold text-2xl text-k-orange">General Open Classes</h3>
                  </div>
                  <div className="space-y-4 text-fg-label">
                    ...
                    <div className="space-y-3">
                      <a href="https://kravist.pushpress.com/landing/plans/plan_cd5f10a5137544/login" target="_blank" rel="noopener noreferrer" className="flex justify-between items-center p-3 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors">
                        ...
                        <span className="text-k-orange">Fridays 6:30pm</span>
                      </a>
                      <a href="https://kravist.pushpress.com/landing/plans/plan_c949e71f9af2d5/login" target="_blank" rel="noopener noreferrer" className="flex justify-between items-center p-3 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors">
                        ...
                        <span className="text-k-orange">Fridays 5:30pm</span>
                      </a>
                      <a href="https://kravist.pushpress.com/landing/plans/plan_f2f2e14d3e5ec5/login" target="_blank" rel="noopener noreferrer" className="flex justify-between items-center p-3 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors">
                        ...
                        <span className="text-k-orange">Sundays 4:30pm</span>
                      </a>
                    </div>
                    <div className="mt-6 p-4 bg-k-orange-hover/20 border border-k-orange-hover/30 rounded-lg">
              ...
              <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-rule text-white">
                <CardContent className="p-8">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h3 className="font-bold text-2xl text-k-orange">Weekend Term Classes</h3>
                  </div>
                  <div className="space-y-4 text-fg-label">
                    <p className="text-lg leading-relaxed">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center p-3 bg-gray-800 rounded-lg">
                        <span className="font-semibold">Kids</span>
                        <span className="text-k-orange font-bold">$470</span>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-gray-800 rounded-lg">
                        <span className="font-semibold">Juniors</span>
                        <span className="text-k-orange font-bold">$520</span>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-gray-800 rounded-lg">
                        <span className="font-semibold">Teens</span>
                        <span className="text-k-orange font-bold">$535</span>
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-3 mt-6">
                      <div className="flex items-center gap-3">
                        <CheckCircle className="h-5 w-5 text-k-orange" />
                  ...
                  <div className="grid lg:grid-cols-3 gap-8 items-start">
                    <div className="lg:col-span-2">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <h3 className="font-bold text-2xl text-k-orange">Leadership Through Action</h3>
                      </div>
                      <p className="text-lg text-fg-label leading-relaxed mb-6">
                      ...
                      <div className="grid md:grid-cols-3 gap-4">
                        <div className="p-4 bg-gray-800 rounded-lg">
                          ...
                          <p className="text-fg-label text-sm">Students practice public speaking in a supportive group environment.</p>
                        </div>
                        <div className="p-4 bg-gray-800 rounded-lg">
                          <h4 className="font-semibold text-white mb-2">Personal Challenges</h4>
                          <p className="text-fg-label text-sm">Real-world challenges that encourage responsibility and personal growth.</p>
                        </div>
                        <div className="p-4 bg-gray-800 rounded-lg">
                          <h4 className="font-semibold text-white mb-2">Reflection & Growth</h4>
                          <p className="text-fg-label text-sm">Each session begins with students sharing experiences and lessons learned.</p>
                        </div>
                      </div>
                    </div>
                    <div className="bg-gradient-to-br from-k-orange-hover/20 to-orange-800/20 p-6 rounded-lg border border-k-orange-hover/30">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-fg-label text-sm">
                        <div className="flex items-center gap-2">
                          <CheckCircle className="h-4 w-4 text-k-orange flex-shrink-0" />
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
              ...
              <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-rule text-white">
                ...
                <CardContent className="p-6">
                  <h3 className="font-bold text-xl mb-2 text-k-orange">Edwin Peng</h3>
                  <p className="text-fg-mute text-sm mb-3">Head Instructor & Founder</p>
                  <ul className="text-fg-label text-sm space-y-1">
              ...
              <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-rule text-white">
                ...
                <CardContent className="p-6">
                  <h3 className="font-bold text-xl mb-2 text-k-orange">Minnie Teo</h3>
                  <p className="text-fg-mute text-sm mb-3">Head of Women's Division</p>
                  <ul className="text-fg-label text-sm space-y-1">
                    <li className="flex items-start">
                      <span className="text-k-orange mr-2">•</span>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto">
              <Accordion type="single" collapsible className="w-full space-y-4">
                {faqs.map((faq, index) => (
                  <AccordionItem key={index} value={`item-${index}`} className="border border-rule rounded-lg bg-gray-900">
                    <AccordionTrigger className="text-left text-white text-lg font-semibold px-6 py-4 hover:text-k-orange hover:no-underline">
                      {faq.question}
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-4 text-fg-label text-lg">
                      {faq.answer}
                    </AccordionContent>
                  </AccordionItem>
                ))}
