        ...
        <Tabs defaultValue="general" className="w-full">
          ...
          <TabsContent value="general">
            <Accordion type="single" collapsible className="space-y-2">
              ...
              <AccordionItem value="wear" className="bg-gray-800/50 border-gray-700 rounded-lg px-4">
              ...
              <AccordionItem value="trial" className="bg-gray-800/50 border-gray-700 rounded-lg px-4">
                ...
                <AccordionContent className="text-gray-300">
                  ...
                  <Link to="/trials" className="text-orange-400 hover:text-orange-300 underline">Trials page</Link>.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="corporate" className="bg-gray-800/50 border-gray-700 rounded-lg px-4">
                ...
                <AccordionContent className="text-gray-300">
                  ...
                  <Link to="/contact" className="text-orange-400 hover:text-orange-300 underline">Contact us</Link> for details.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </TabsContent>
          ...
          <TabsContent value="youth">
            <Accordion type="single" collapsible className="space-y-2">
              ...
              <AccordionItem value="missed" className="bg-gray-800/50 border-gray-700 rounded-lg px-4">
              ...
              <AccordionItem value="parent" className="bg-gray-800/50 border-gray-700 rounded-lg px-4">
              ...
              <AccordionItem value="enrol" className="bg-gray-800/50 border-gray-700 rounded-lg px-4">
                ...
                <AccordionContent className="text-gray-300">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <a
                      ...
                      className="inline-flex items-center justify-center bg-orange-600 hover:bg-orange-700 text-white font-semibold py-2 px-5 rounded transition-colors text-sm"
                    >
                      Join Waitlist
                    </a>
                    <Link
                      to="/trials"
                      className="inline-flex items-center justify-center border border-orange-500 text-orange-400 hover:bg-orange-500/10 font-semibold py-2 px-5 rounded transition-colors text-sm"
                    >
                      Book Trial
                    </Link>
                  </div>
          ...
          <TabsContent value="getting-started">
            <Accordion type="single" collapsible className="space-y-2">
              <AccordionItem value="first-class" className="bg-gray-800/50 border-gray-700 rounded-lg px-4">
              ...
              <AccordionItem value="booking" className="bg-gray-800/50 border-gray-700 rounded-lg px-4">
              ...
              <AccordionItem value="frequency" className="bg-gray-800/50 border-gray-700 rounded-lg px-4">
              ...
              <AccordionItem value="grading" className="bg-gray-800/50 border-gray-700 rounded-lg px-4">
