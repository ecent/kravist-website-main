  ...
  return (
    <footer className="bg-black py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-fg-mute mb-6">Krav Maga self-defence for families in Singapore — kids, teens, adults, and corporate teams.</p>
        ...
        <div className="text-sm text-fg-mute mb-6 space-y-1">
        ...
        <div className="flex justify-center space-x-6">
          <Link to="/contact" className="text-fg-mute hover:text-white transition-colors">
            Contact Us
          </Link>
          <a href="#divisions" className="text-fg-mute hover:text-white transition-colors">
            Programs
          </a>
          <Link to="/privacy" className="text-fg-mute hover:text-white transition-colors">
            Privacy Policy
          </Link>
        </div>
      </div>
